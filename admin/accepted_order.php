...
<html lang="en">
<head><title>Accepted Orders</title>
                ...
                <div class="panel panel-default" >
                  <div class="panel-heading">
                        <div class="panel-title"> 
                            <marquee direction="right">  <a><strong style="color:red; "><i class="glyphicon glyphicon-link"></i>  &nbsp; Rejected Orders</strong></a>  </marquee>
                        </div>
                  </div>
                  <div class="panel-body" > 
                    ...
                    <table class="table">
                      ...
                      <?php
                        $qry="select * from place_order where order_status='1'";
